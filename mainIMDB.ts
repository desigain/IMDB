...
// readline.question(`Inserte titulo: ${name}`),
// (userInput) => {
...
let actor1Movie2 = new Professional(
  "Santiago Segura",
  55,
  "Masculino",
  80,
...
let actor2Movie2 = new Professional(
  "Toni Acosta",
  48,
  "Femenino",
  55,
...
let actor3Movie2 = new Professional(
  "Loles León",
  70,
  "Femenino",
  62,
...
let directorMovie2 = new Professional(
...
let escritorMovie2 = new Professional(
...
//Película 3:
//Creamos objetos de clase Professional para añadirlos más tarde en el atributo actors al objeto Movie.
let actor1Movie3 = new Professional(
  "Tom Hanks",
  64,
  "Masculino",
  86,
...
let actor2Movie3 = new Professional(
  "Robin Wright",
  54,
  "Femenino",
  59,
...
let actor3Movie3 = new Professional(
  "Gary Sinise",
  65,
  "Masculino",
  70,
...
let directorMovie3 = new Professional(
  "Robert Zemeckis",
  68,
  "Masculino",
  74,
...
let escritorMovie3 = new Professional(
  "Eric Roth",
  75,
  "Masculino",
  78,
...
//Película 4:
//Creamos objetos de clase Professional para añadirlos más tarde en el atributo actors al objeto Movie.
let actor1Movie4 = new Professional(
  "Kristen Bell",
  40,
  "Femenino",
  50,
...
let actor2Movie4 = new Professional(
  "Indina Menzel",
  49,
  "Femenino",
  52,
...
let actor3Movie4 = new Professional(
  "Jonathan Groff",
  35,
  "Masculino",
  77,
...
let actor4Movie4 = new Professional(
  "Josh Gad",
  39,
  "Masculino",
  72,
...
let actor5Movie4 = new Professional(
  "Santino Fontana",
  38,
  "Masculino",
  81,
...
//Creamos el array de objetos professional que incluye nuestros actores para añadirlo en el atributo actores de nuestro objeto Movie.
let actoresMovie4: Professional[] = [
  actor1Movie4,
  actor2Movie4,
  actor3Movie4,
  actor4Movie4,
...
// Creamos los objetos de la clase Professional Director (con atributo profesión director) y Escritor (con atributo profesión guionista) para incluirlos como atributos de nuestro objeto Movie.
let directorMovie4 = new Professional(
  "Chris Buck",
  62,
  "Masculino",
  88,
...
let escritorMovie4 = new Professional(
  "Jennifer Lee",
  48,
  "Femenino",
  66,
...
let movie4 = new Movie(
  ...
  2013,
  "Estados Unidos",
  "Animación | Infantil | Fantástico | Musical | Aventuras"
);
...
let stringConversor = JSON.stringify(myIMBD);
//Este método recibe como parámetros las stringConversor, que es el nombre de la variable en la que guardamos nuestro archivo json que creamos.
//Devuelve el archivo creado en JSON, es decir, lo "escribe"
// fs.writeFile(file, stringConversor, function (err) {  // file es 
//   if (err) {
...
//   if (err) throw err;
//   let readObject: IMDB = JSON.parse(file); // Aquí estamos almacenando el fichero json en una instancia (variable) de la clase IMDB

//   console.log(readObject.peliculas[0].title); // ahora podemos acceder a las propiedades del objeto y leer json por consola
// });

myIMBD.escribirJSON("prueba.json");

myIMBD.obtenerInstancia("prueba.json")